# Generated by Django 3.2.16 on 2024-12-09 10:57
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('blog', '0002_rename_publish_date_post_pub_date'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='category',
            name='slug',
            field=models.SlugField(help_text='Идентификатор страницы для URL; разрешены латиница, цифры, дефисы и подчёркивания.', unique=True, verbose_name='Идентификатор'),
        ),
        migrations.AlterField(
            model_name='category',
            name='title',
